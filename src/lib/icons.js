...
export function getAccessibilityBadgeIcon(modifier) {
    if (modifier === "yes") {
        return `<svg viewBox="386 188 20 16" width="16" height="16" aria-hidden="true" focusable="false">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M392.642 201.032L404.014 188L405.5 189.304L392.677 204L386.5 197.243L387.956 195.905L392.642 201.032Z" fill="currentColor"/>
        </svg>`;
    }
    if (modifier === "no") {
        return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M21 4.58663L19.5704 3L12.0052 10.4954L4.42957 3L3 4.58663L10.4817 12.0055L3 19.4134L4.42957 21L12.0052 13.5046L19.5704 21L21 19.4134L13.5183 12.0055L21 4.58663Z" fill="red"/>
        </svg>`;
    }
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M9.59426 16.7782V17.0632H13.211V16.7782C13.2183 16.0035 13.3088 15.353 13.4825 14.8268C13.6636 14.2933 13.9387 13.8292 14.308 13.4346C14.6845 13.0399 15.166 12.6599 15.7525 12.2944C16.4187 11.8925 16.9943 11.4357 17.4794 10.9241C17.9646 10.4125 18.3375 9.82779 18.5981 9.17002C18.866 8.51225 19 7.76678 19 6.9336C19 5.69846 18.7031 4.63141 18.1094 3.73246C17.5229 2.8262 16.7011 2.12823 15.6439 1.63856C14.594 1.14889 13.3776 0.904053 11.9946 0.904053C10.7274 0.904053 9.56892 1.13793 8.51901 1.60567C7.47634 2.07342 6.63641 2.77504 5.99922 3.71054C5.36928 4.64603 5.0362 5.80809 5 7.19671H8.86656C8.90277 6.50971 9.0693 5.9433 9.36618 5.49747C9.67029 5.04434 10.0504 4.70815 10.5066 4.4889C10.97 4.26233 11.4588 4.14905 11.9728 4.14905C12.5304 4.14905 13.0336 4.26598 13.4825 4.49986C13.9387 4.73373 14.3008 5.06262 14.5687 5.48651C14.8366 5.91041 14.9705 6.41104 14.9705 6.98842C14.9705 7.50002 14.8691 7.96411 14.6664 8.3807C14.4637 8.78997 14.1849 9.16271 13.8301 9.49891C13.4825 9.82779 13.0879 10.1311 12.6462 10.4088C12.0018 10.8108 11.4551 11.253 11.0062 11.7353C10.5573 12.2104 10.2097 12.8389 9.96354 13.6209C9.72459 14.4029 9.6015 15.4554 9.59426 16.7782Z" fill="#181818"/>
        <path d="M9.80062 23.2024C10.2713 23.6702 10.8324 23.9041 11.4841 23.9041C11.9185 23.9041 12.3132 23.7981 12.668 23.5861C13.03 23.3669 13.3196 23.0745 13.5368 22.7091C13.7613 22.3437 13.8735 21.9381 13.8735 21.4922C13.8735 20.8345 13.6346 20.2717 13.1567 19.804C12.6861 19.3362 12.1285 19.1023 11.4841 19.1023C10.8324 19.1023 10.2713 19.3362 9.80062 19.804C9.32997 20.2717 9.09465 20.8345 9.09465 21.4922C9.09465 22.1646 9.32997 22.7347 9.80062 23.2024Z" fill="#181818"/>
    </svg>`;
}
