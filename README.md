...
- **cordinaten amsterdam**
 - **OpenAI. (2026). Codex [Large language model]. OpenAI**
 - Ik maak gebruik van L.latLngBounds() in Leaflet om de kaart te beperken tot Amsterdam. Welke coördinaten kan ik hiervoor gebruiken
